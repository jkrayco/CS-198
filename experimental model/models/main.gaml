...
global {
	init {
		if (run = 1){
			save ["run", "cat", "S", "SO3", "H2", "photon", "electron", "hole", "cat_H2O", "HS", "OH", "cat_HS", "cat_sulfite", "cat_H", "cat_OH", "cat_HS0", "cat_S0", "cat_HS2", "HS2", "S2O3", "cat_S2O3"] to: batch_code+"_"+K1+"_"+K2+"_"+K3+"_"+K4+"_"+K5+"_"+K6+"_"+K7+"_"+K8+"_"+K9+"_"+K10+"_"+K11+"_"+K12+"_"+K13+"_"+K14+"_"+K15+"_"+var_code+"_hour4.csv" type:csv;
			save ["run", "time", "cat", "S", "SO3", "H2", "photon", "electron", "hole", "cat_H2O", "HS", "OH", "cat_HS", "cat_sulfite", "cat_H", "cat_OH", "cat_HS0", "cat_S0", "cat_HS2", "HS2", "S2O3", "cat_S2O3"] to: batch_code+"_"+K1+"_"+K2+"_"+K3+"_"+K4+"_"+K5+"_"+K6+"_"+K7+"_"+K8+"_"+K9+"_"+K10+"_"+K11+"_"+K12+"_"+K13+"_"+K14+"_"+K15+"_"+var_code+".csv" type:csv;
		}
	}
	reflex updateLight {
...
experiment now type:gui {
	parameter "Batch Code" var: batch_code among: ["model"];
	parameter "Variable Code" var: var_code among: ["k1d_time"];
	...
	output{
		...
		monitor "K1d" value:K1d;
	}
}

experiment batch type:batch repeat:1 until: (cycle = (cph*4)+1){//cycle = (cph*8)+1)){
	parameter "Batch Code" var: batch_code among: ["model"];
	parameter "Variable Code" var: var_code among: ["k1d300_k3_cat"];
...
//	parameter "K2" var: K2 among: [49.0];	//electron + hole -> {}
//	parameter "K3" var: K3 among: [0.045]; 	//cat + H2O -> cat-H2O
//	parameter "K4" var: K4 among: [0.03];	//S 2- + H2O -> HS- + OH -	x					
